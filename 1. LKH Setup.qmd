...
## 1.2  Changeable parameters and constraints

**User Inputs**

- Current speed limit is                    10 mph 
- Current travel time of a blocked road:    60 minutes
- Road width:                               24 feet
- Road blockage threshold:                  50%

**LKH Constraints**

- Max time allowed for piling:  480 minutes
- Max time allowed per truck:   600 minutes
- Max number of trucks:         74
- Number of residential nodes:  20
...
## 1.3  Convert data types to geometry  
...
# 2     PHASE 1: EXPEDITED CONNECTIVITY RESTORATION

# 2.1   Identify blocked roads
...
RUN "RUN ABOVE" AT THIS CODE BLOCK
```{python}
...
# 3     PHASE 2: CAPACITATED DEBRIS REMOVAL
